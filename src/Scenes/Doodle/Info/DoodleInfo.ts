export default abstract class DoodleInfo {
  ...
  public static readonly QUESTIONS: {
    ...
    {
      question: 'Wat is de sterkste pincode?',
      answers: [
    ...
    {
      question: 'Hoe veilig is openbare wifi?',
      answers: [
    ...
    {
      question: 'Wat kun je doen om je privacy en veiligheid te verbeteren op sociale media?',
      answers: [
    ...
    {
      question: 'Wat doe je als een onbekend persoon je wilt volgen op Instagram?',
      answers: [
    ...
    {
      question: "Kunnen alle foto's die je online zet door iedereen worden gezien?",
      answers: [
    ...
    {
      question: 'Wat doe je met een foto op Instagram van jou waar geen toestemming voor is gegeven?',
      answers: [
    ...
    {
      question: 'Wat doe je als een onbekende jou online vraagt om je echte naam?',
      answers: [
    ...
    {
      question: 'Waarom mag je op Facebook geen account maken als je nog geen 16 jaar bent?',
      answers: [
    ...
    {
      question: 'Wat doe je als een onbekende een vriendschapsverzoek stuurt?',
      answers: [
